const Decimal = (function () { 'use strict';
  ...
  /**
   * @param {Decimal} cost
   * @param {Number|Decimal} currentRpS
   * @param {Number|Decimal} deltaRpS
   * @returns {Decimal}
   */
   ...
   */
    function Decimal(value) {
      ...
      if (value === undefined) {
        ...
        console.log(value);
        throw new TypeError("[Decimal Rrror]");
      }
    }
     ...
     * @returns {String}
     */
    Decimal.toFixed = function (value, places) {
